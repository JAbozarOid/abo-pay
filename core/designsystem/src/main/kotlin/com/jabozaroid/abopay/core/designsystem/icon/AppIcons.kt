package com.jabozaroid.abopay.core.designsystem.icon
...
object AppIcons {
    ...
    val Password = Icons.Rounded.RemoveRedEye
    val Calendar = Icons.Rounded.CalendarMonth
    val CalendarBorder = Icons.Outlined.CalendarMonth
    val Clock = Icons.Filled.AccessTimeFilled
    val ClockBorder = Icons.Outlined.AccessTime
    val Profile = Icons.Filled.Person
    val ProfileBorder = Icons.Outlined.Person
    val Line = Icons.Filled.Remove
    val Category = Icons.Rounded.Category
    val close = Icons.Filled.Close

    val Today = Icons.Filled.Today
    val TodayBorder = Icons.Outlined.Today

    val bottom = R.drawable.ic_copy
    val icRemove = R.drawable.ic_remove
    val icRetry = R.drawable.ic_retry
    val icMoreBlack = R.drawable.ic_more_black
    val icSetting = R.drawable.ic_setting
    val icClose = R.drawable.ic_close
    val icEdit = R.drawable.ic_edit_item
