...
//        val formattedNumber = intPart + decimalSeparator + fractionPart
        ...
        val offsetMapping = if (fixedCursorAtTheEnd) {
            com.jabozaroid.abopay.core.common.util.CurrencyAmountInputVisualTransformation.FixedCursorOffsetMapping(
                contentLength = inputText.length,
                formattedContentLength = formattedNumber.length
            )
        } else {
            com.jabozaroid.abopay.core.common.util.CurrencyAmountInputVisualTransformation.MovableCursorOffsetMapping(
